...
var current_users : string[] =  ["Alice", "Bob", "Charlie", "david", "kaif"];
var new_users : string[] = ["john", "alice", "Eve", "kaif", "david"]

for (let user of new_users) {
    if (current_users.includes(user)) {
        console.log(`The username "${user}" is already taken. enter a new user`);
        } else {
