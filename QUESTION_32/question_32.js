...
var current_users = ["Alice", "Bob", "Charlie", "david", "kaif"];
var new_users = ["john", "alice", "Eve", "kaif", "david"];
for (var _i = 0, new_users_1 = new_users; _i < new_users_1.length; _i++) {
    var user = new_users_1[_i];
    if (current_users.includes(user)) {
        console.log("The username \"".concat(user, "\" is already taken. enter a new user"));
    }
    else {
