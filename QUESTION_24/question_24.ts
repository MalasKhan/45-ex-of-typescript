...
let string = "car"
let string2 = "cat"
let larray: string[] =  ["dog", "cat", "elephant"]
...
console.log(larray.includes("dog"), "is dog included in the list of animals?");//true

console.log(!larray.includes("zebra"), "Is zebra NOT included in the list of animals?");//true
